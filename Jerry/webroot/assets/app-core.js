  (function() {
    ...
    var _customKeyboxDialogOpen = false;
    function openCustomKeyboxDialog() {
      if (_customKeyboxDialogOpen) return;
      _customKeyboxDialogOpen = true;
      var modDir = '/data/adb/modules/JerryManager';
      ...
      applyBtn.addEventListener('click', function() {
        var value = selectedFilePath || '';
        if (!value) { alert('Please select a file'); return; }
        var type = 'path';
